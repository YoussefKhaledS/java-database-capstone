...
(function () {
  // Render a static footer into the page
  function renderFooter() {
    const footer = document.getElementById('footer');
    if (!footer) return; // nothing to do if placeholder is missing
  ...
  // Expose for manual invocation if needed and call on DOM ready
